...
public class SimpleRecursion {
	...
	// version 2
	public static void recurB(int k) {
	...
	// version 3
	public static void recurC(int k) {
		if(k == 5) {
			System.out.println("count = " + k);
			recur(k + 1);
		}
	...
	// version 4
	public static void recurD(int k) {
		if(k < 5) {
			System.out.println("count = " + k);
			recur(k + 1);
		}
	...
	// version 5
	public static void recurE(int k) {
		System.out.println("count = " + k);
		if(k == 5) {
			recur(k + 1);
		}
	...
	// version 6
	public static void recurF(int k) {
		if(k != 5) {
			System.out.println("count = " + k);
			recur(k + 1);
		}
