...
public class NaiveReverse {
	...
	public String reverse7 (String s) {
		return (s.substring(6, 7) + s.substring(5, 6) + s.substring(4, 5) + s.substring(3, 4) + s.substring(2,3) + s.substring(1, 2) + s.substring(0, 1));
		}
	public String reverse8 (String s) {
		return (s.substring(7, 8) + s.substring(6, 7) + s.substring(5, 6) + s.substring(4, 5) + s.substring(3, 4) + s.substring(2,3) + s.substring(1, 2) + s.substring(0, 1));
	...
	public static void main(String[] args) {
		...
		System.out.println(obj.reverse9("confident"));
	}
